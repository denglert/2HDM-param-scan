...
echo -e "###############################"
echo -e "### --- Interactive run --- ###"
echo -e "###############################\n\n"

echo -e "Current directory: $(pwd)"
echo -e "Using parameter config file: $CONFIG\n"

echo -e "nmhBins: $nmhBins"
echo -e "mhMin: $mhMin"
echo -e "mhMax: $mhMax"
echo -e "mhBinWidth: $mhBinWidth"

echo -e "\n"

echo "nmHBins: $nmHBins"
echo "mHMin: $mHMin"
echo "mHMax: $mHMax"
echo "mHBinWidth: $mHBinWidth"

echo -e "\n"
echo "nCosBABins: $nCosBABins"
echo "CosBAMin: $CosBAMin"
echo "CosBAMax: $CosBAMax"
echo "CosBABinWidth: $CosBABinWidth"

echo -e "\n"
echo "nTanBins: $nTanBBins"
echo "TanBMin: $TanBMin"
echo "TanBMax: $TanBMax"
echo "TanBBinWidth: $TanBBinWidth"

echo -e "\n"
echo "nmABins: $nmABins"
echo "mAMin: $mAMin"
echo "mAMax: $mAMax"
echo "mABinWidth: $mABinWidth"

echo -e "\n"
echo "nZ7Bins: $nZ7Bins"
echo "Z7Min: $Z7Min"
echo "Z7Max: $Z7Max"
echo "Z7BinWidth: $Z7BinWidth"

echo -e "\n"
echo -e "Run will start in 10.."
sleep 5
echo -e "Run will start in 5.."
sleep 1
echo -e "Run will start in 4.."
sleep 1
echo -e "Run will start in 3.."
sleep 1
echo -e "Run will start in 2.."
sleep 1
echo -e "Run will start in 1.."
sleep 1
